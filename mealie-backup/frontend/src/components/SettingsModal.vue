  ...
  >
    ...
    <div class="relative w-full max-w-2xl bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl flex flex-col" style="max-height: min(680px, 90vh)">
          ...
          <div v-if="activeTab === 'automation'" class="p-6 space-y-6">
              ...
              <div v-if="form.schedule.enabled" class="space-y-3 pl-0">
                <div class="flex flex-wrap gap-2">
                  <button
                    ...
                    :class="activePreset === p.cron ? 'bg-green-600 text-white' : 'bg-zinc-800 text-zinc-400 hover:text-zinc-200'"
            ...
            <div class="space-y-4">
              ...
              <div v-if="form.retention.enabled" class="space-y-3">
                <div class="grid grid-cols-2 gap-3">
                  <div>
                    <label class="block text-sm text-zinc-300 mb-1.5">Keep last</label>
                    <div class="flex items-center gap-2">
                      ...
                      />
                      <span class="text-sm text-zinc-600 shrink-0">backups</span>
                    </div>
                  </div>
                  <div>
                    <label class="block text-sm text-zinc-300 mb-1.5">Keep for</label>
                    <div class="flex items-center gap-2">
                      <input
                      ...
                      />
                      <span class="text-sm text-zinc-600 shrink-0">days</span>
                    </div>
                  </div>
                </div>
                <p class="text-xs text-zinc-600">A backup is kept if either rule saves it. Set to 0 to disable a rule.</p>
              </div>
            </div>
          </div>
          ...
          <div v-if="activeTab === 'security'" class="p-6 space-y-6">
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                ...
                <button
                  class="relative w-10 h-5 rounded-full transition-colors shrink-0"
                  :class="form.auth.oidc.enabled ? 'bg-green-600' : 'bg-zinc-700'"
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-center justify-between">
                  <span
                    v-if="passwordResult"
                    class="flex items-center gap-1.5 text-sm"
                    :class="passwordResult.ok ? 'text-green-400' : 'text-red-400'"
                  >
      ...
      <div class="flex-none px-5 py-4 border-t border-zinc-800 flex items-center justify-end gap-3">
        ...
        >Cancel</button>
        <button
          class="rounded-xl px-5 py-2 text-sm font-medium bg-green-600 hover:bg-green-500 text-white transition-colors disabled:opacity-50"
          :disabled="saving"
